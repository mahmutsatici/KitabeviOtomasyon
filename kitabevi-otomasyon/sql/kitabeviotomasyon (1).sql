...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 15 May 2023, 14:25:35
...
(1, '1984', 328, 50, 25.5, '1949', 3, 2, 1, 'https://www.dostkitabevi.com/images/thumbs/0091302_1984_550.jpeg'),
(2, 'Suç ve Ceza', 576, 25, 32, '1866', 2, 1, 2, 'https://www.dostkitabevi.com/images/thumbs/0124240_Su%20ve%20Ceza_550.jpeg'),
(3, 'Küçük Kara Balık', 56, 100, 7, '1967', 1, 3, 3, 'https://www.dostkitabevi.com/images/thumbs/0013975_K%20k%20Kara%20Bal%20k_550.jpeg'),
(4, 'Benim Adım Kırmızı', 423, 10, 28.5, '1998', 2, 4, 4, 'https://www.dostkitabevi.com/images/thumbs/0077140_Benim%20Ad%20m%20K%20rm%20z%20_550.jpeg'),
(5, 'Harry Potter ve Felsefe Taşı', 256, 75, 22, '1997', 3, 1, 5, 'https://www.dostkitabevi.com/images/thumbs/0077934_harry-potter-ve-felsefe-tasi-1_550.jpeg'),
...
(8, 'ryurjhjr', 'eryhthr', 'zsvzfb', 123, 'ethrgjr', '1234');
...
--
ALTER TABLE `yayinevi`
  MODIFY `yayinevi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `yazar`
--
ALTER TABLE `yazar`
  MODIFY `yazar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
